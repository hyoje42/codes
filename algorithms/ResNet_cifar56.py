...
layer1 = layer(input2, init_n, 9)
res1 = layer1.implement(1)
layer2 = layer(res1, init_n*2, 9)
res2 = layer2.implement()
layer3 = layer(res2, init_n*4, 9)
...
model.compile(loss=losses.categorical_crossentropy, optimizer=optimizers.sgd(lr=0.001, decay=0.0001, momentum=0.9),
             metrics=['accuracy'])
