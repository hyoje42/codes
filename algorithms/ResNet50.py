...
class layer:
    ...
    def add(self, filter_n):
        tower_1 = Conv2D(filter_n, (1, 1), padding='same')(self.result)
        ...
        tower_3 = Conv2D(filter_n*4, (1, 1), padding='same')(tower_2)
        tower_3 = BatchNormalization(axis=3)(tower_3)
        one_by_one = Conv2D(filter_n*4, (1, 1), padding='same')(self.result)
        add_1 = Add()([tower_3, one_by_one])
        add_1 = Activation('relu')(add_1)
        
        return add_1
    
    def implement(self, stride=2):
        tower_1 = Conv2D(self.filter_n, (1, 1), strides=stride, padding='same')(self.result)
        tower_1 = BatchNormalization(axis=3)(tower_1)
        tower_1 = Activation('relu')(tower_1)
        tower_2 = Conv2D(self.filter_n, (3, 3), padding='same')(tower_1)
        tower_2 = BatchNormalization(axis=3)(tower_2)
        tower_2 = Activation('relu')(tower_2)
        tower_3 = Conv2D(self.filter_n*4, (1, 1), padding='same')(tower_2)
        tower_3 = BatchNormalization(axis=3)(tower_3)
        one_by_one = Conv2D(self.filter_n*4, (1, 1), strides=stride, padding='same')(self.result)
        self.result = Add()([tower_3, one_by_one])
...
input2 = Conv2D(init_n, (3, 3), strides=1, padding='same')(input1) # in paper (7, 7)
