# python cutout.py -g 1 -s cifar10_standarz_cutout -d cifar10 -b 128 -e 100 --cs 16 --cutout 1 --standarz 1
# python cutout.py -g 1 -s cifar100_baseline -d cifar100 -b 128 -e 100
...
if __name__ == '__main__':
    ...
    logger.info('gpu : {}, cutout : {}, standardization : {}'.format(args.gpu_id, 
                                                                bool(args.is_cutout), 
    ...
    for epoch in range(EPOCHS):
        ...
        # cutout
        if args.is_cutout:
            logger.info('with cutout using {} size'.format(args.cutout_size))
