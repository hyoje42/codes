...
#                         action='store_true')
    parser.add_argument('-df', '--df_specific', dest='df_specific', help='specific df or otherwise',
                        default=0, type=int)
    parser.add_argument('-vg', '--vgg', dest='vgg', help='vgg16 or vgg19',
                        default='vgg16')
...
M = VggNet_DF_one(gpu_id=args.gpu_id, want_size=args.size, batch_size=args.batch_size, 
